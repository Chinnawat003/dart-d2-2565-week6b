void main() {
  MyApp std1 = MyApp(stdName: "Dong", stdAge: 19, stdId: 101);
  MyApp std2 = MyApp(stdName: "Tato", stdAge: 19, stdId: 102);
  MyApp std3 = MyApp.stdGpa(stdName: "Hon", stdAge: 20, stdId: 103);
...
class MyApp {
  ...
  //5.Named Constructor
  MyApp.stdGpa({required this.stdName, required this.stdAge, this.stdId})
      : stdGpa = 4;
}
